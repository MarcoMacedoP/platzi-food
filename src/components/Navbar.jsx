  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="mt-2 flex transition-all duration-200 ease-out overflow-hidden w-11/12
                  lg:w-4/12
        "
      >
        <input
          ...
          className="
            w-4/6
            py-1 px-2 text-gray-900 
            rounded-lg text-sm border-b-4 
            border-transparent 
        ...
        <button
          type="submit"
          className="rounded-md flex hover:opacity-50 transition-opacity duration-200 ease-linear justify-center items-center bg-primary w-2/6 h-8 ml-2"
        >
